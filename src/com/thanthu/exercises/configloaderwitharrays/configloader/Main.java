package com.thanthu.exercises.configloaderwitharrays.configloader;
...
import com.thanthu.exercises.configloaderwitharrays.data.GameConfig;
import com.thanthu.exercises.configloaderwitharrays.data.UserInterfaceConfig;


public class Main {

	private static final Path GAME_CONFIG_ARR_PATH = Path.of("resources/game-properties-arr.cfg");
	private static final Path UI_CONFIG_ARR_PATH = Path.of("resources/user-interface-arr.cfg");

	public static void main(String[] args) throws InvocationTargetException, NoSuchMethodException,
			InstantiationException, IllegalAccessException, IOException {
		GameConfig gameConfig = createConfigObject(GameConfig.class, GAME_CONFIG_ARR_PATH);
		UserInterfaceConfig userInterfaceConfig = createConfigObject(UserInterfaceConfig.class, UI_CONFIG_ARR_PATH);

		System.out.println(gameConfig);
		System.out.println(userInterfaceConfig);
	}

	public static <T> T createConfigObject(Class<T> clazz, Path filePath) throws IOException, NoSuchMethodException,
