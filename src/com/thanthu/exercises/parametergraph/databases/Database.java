package com.thanthu.exercises.parametergraph.databases;
...
public class Database {
	...
	private Map<String, List<Float>> GAME_TO_PRICE = Map.of("Fortnite", Arrays.asList(5f, 10f), "Minecraft",
			Arrays.asList(4.3f, 100f), "League Of Legends", Arrays.asList(4.9f, 89f), "Ace Combat",
			Arrays.asList(4.8f, 50f), "StarCraft", Arrays.asList(4.7f, 66f), "Burnout", Arrays.asList(4.4f, 31f));
